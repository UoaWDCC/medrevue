...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="overflow-y-auto bg-[#070507]">
      <section
        ref={bgRef}
        className="relative w-full h-160 md:h-screen bg-no-repeat bg-center bg-cover bg-[#070507]"
        style={{
          backgroundImage: `url(${medrevueHomeBackground})`,
          backgroundPosition: 'center 60%',
        }}
      >
        <div className="absolute top-[24%] md:top-[clamp(24%, 40%, 36%)] ml-[clamp(48px,10vw,96px)] md:ml-[10%] flex flex-col gap-6">
          <h1 className="text-left text-[#E5CE63] font-bold font-poppins text-[clamp(3.5rem,8vw,6rem)]">
            Auckland MedRevue
          </h1>

          <h2 className="hidden md:block mt-[-3%] text-[#FFF0A2] text-left font-bold font-inter font-medium text-[clamp(1rem,3vw,1.5rem)]">
            A University of Auckland non-profit production
          </h2>
        </div>

        <div className="hidden md:block absolute top-[66%] ml-[10%] text-left text-[#FFFBE8] font-inter font-semibold text-[clamp(1.5rem,3vw,2rem)]">
          {' '}
        ...
        <h2 className="block md:hidden absolute top-[50%] ml-12 ml-[clamp(48px,10vw,96px)] text-left text-[#FFFBE8] font-inter font-semibold text-[clamp(1rem,3vw,2rem)]">
          14th August - 16th August 2025
        </h2>

        <div className="block md:hidden absolute bottom-[12%] left-1/2 -translate-x-1/2 flex flex-col items-center">
          <h2 className="text-center text-[#FFFBE8] font-inter font-semibold text-[clamp(1rem,3vw,2rem)]">
            Our 2025 show
          </h2>
      ...
      <section
        ...
        className="relative min-h-screen bg-[#070507] flex sm:h-screen flex flex-col items-center "
      >
        <div className="absolute mt-[4%] w-full flex flex-col items-center text-center md:items-end md:text-right md:pr-[10%]">
          <h2
            ref={h2FadeInRef}
            className="hidden md:block text-[#FFF0A2] font-inter font-medium text-xl mb-4 text-[clamp(1.25rem,3vw,1.5rem)]"
          >
            Our 2025 Show
          </h2>
          ...
          <h1
            ref={textRef}
            className="text-[#E5CE63] font-poppins font-bold text-[clamp(1.875rem,5vw,4rem)] md:text-[clamp(3.75rem, 5vw, 5rem)] text-center md:text-right whitespace-nowrap"
          >
            BACK TO THE SUTURE
          </h1>
          <h2 className="text-[#E5CE63] font-inter font-light text-[clamp(1rem,5vw,1.5rem)] text-center md:text-[clamp(1.25rem, 5vw, 3rem)] mb-10 max-w-[425px] mt-[4%] md:mt-0 md:ml-auto md:text-right">
          ...
          <img
            ...
            className="md:absolute lg:mt-[5%] md:mt-[15%] md:left-[10%] w-[210px] h-auto md:w-[clamp(210px,25vw,280px] lg:w-[clamp(280px,25vw,350px)] lg:block"
          />

          <div className="flex flex-col mt-10 relative md:absolute md:mt-50 text-[1rem] mx-auto w-[clamp(300px,80%,450px)] items-center text-center ">
            <div
              ref={divFadeInRef}
              className="text-[#FFFBE8] font-inter font-light md:left-0 md:text-xl md:translate-x-0 md:max-w-[425px] text-center md:text-right flex flex-col gap-4"
            >
              <p>
              ...
              <p className="text-[#FFFBE8] font-inter font-light  md:text-xl md:max-w-[425px] md:ml-auto text-center md:text-right gap-10 lg:gap-15">
            ...
            >
              <svg
                viewBox="0 0 310 74"
                fill="none"
                aria-label="Buy Tickets Button"
                xmlns="http://www.w3.org/2000/svg"
                className="relative w-full h-full mt-[5%] md:mt-[11%] left-1/2 -translate-x-1/2  md:ml-[25%]"
              ...
              >
                <rect
                  ...
                  rx="9.5"
                  stroke="#FFFBE8"
                  className="fill-[#E5CE63] stroke-[#070507] md:fill-none md:stroke-[#FFFBE8]"
                  strokeWidth="3"
                />
                ...
                <path
                  ...
                  fill="#FFFBE8"
                  className="fill-[#070507] md:fill-[#FFFBE8]"
                />
              </svg>
            </Button>
          </div>
        ...
        <div className="hidden md:flex flex-col items-center mt-165 text-[#FFFBE8] font-inter font-semibold text-[1.75rem] space-y-2">
          <div
            className="flex justify-center w-full space-x-25"
            ref={TextZoomRef}
          >
            <h2 className="text-center">
              14 - 16 Aug, 7:30pm - 10:00 pm <br /> (doors will open at 6:45pm)
            </h2>
            <h2 className="text-center">SkyCity Theatre</h2>
          </div>
        </div>
      </section>
    </div>
