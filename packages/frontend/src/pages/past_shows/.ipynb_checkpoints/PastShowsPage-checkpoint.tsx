...
import CurrentShowCard, {type CurrentShowCardProps} from '../../components/Cards/CurrentShowCard';
...
export default function PastShowsPage() {
    ...
    const currentShowInfo: CurrentShowCardProps = {
        ...
        location: "SkyCity Theatre, Corner Hobson Street and Wellesley Street West, Auckland 1010"
    }

    return (
        <div className="overflow-x-hidden">
            <section className="bg-[var(--colour-background-primary)] w-screen h-[100vh] flex flex-col justify-center items-center">
                <h1 className="text-[56px] pb-5 text-[var(--colour-background-secondary)]">Our 2026 Show</h1>
